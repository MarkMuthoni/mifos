...
const AmazonS3Service = () => {
    ...
    const fetchS3Data = async () => {
        startLoading();
        try {
            const response = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/externalservice/S3`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/externalservice/S3`,
                formValues,
                {
                    headers: {
                        Authorization: `Basic ${user.base64EncodedAuthenticationKey}`,
