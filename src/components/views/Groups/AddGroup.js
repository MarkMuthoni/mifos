...
const AddGroupForm = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const clientResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/clients`, { headers });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups`, payload, { headers });
