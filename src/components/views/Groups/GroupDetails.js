...
const GroupDetails = ({ groupId, onClose }) => {
        ...
        if (activeTab === 'general') {
            const fetchGeneralTabData = async () => {
                ...
                try {
                    ...
                    // Fetch group details
                    const groupResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all`, { headers });
                    setGroupDetails(groupResponse.data);

                    // Fetch group summary counts
                    const summaryResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/runreports/GroupSummaryCounts?R_groupId=${groupId}&genericResultSet=false`, { headers });
                    ...
                    const accountsResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/accounts`, { headers });
                    setGroupDetails((prevDetails) => ({
                        ...prevDetails,
                    ...
                    // Fetch GSIM accounts
                    const gsimAccountsResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/gsimaccounts`, { headers });
                    setGroupDetails((prevDetails) => ({
                        ...prevDetails,
                    ...
                    // Fetch GLIM accounts
                    const glimAccountsResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/glimaccounts`, { headers });
                    setGroupDetails((prevDetails) => ({
                        ...prevDetails,
            ...
            const fetchNotes = async () => {
                ...
                try {
                    const response = await axios.get(
                        `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/notes`,
                        { headers }
                    );
        ...
        if (activeTab === 'committee') {
            const fetchCommitteeData = async () => {
                ...
                try {
                    ...
                    const response = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all&template=true`, { headers });
    ...
    const handleSaveNote = async () => {
        ...
        const endpoint = editingNoteId
            ? `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/notes/${editingNoteId}`
            : `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/notes`;
    ...
    const handleDeleteNote = async (noteId) => {
        ...
        try {
            startLoading();
            await axios.delete(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/notes/${noteId}`,
                { headers }
            );
    ...
    const handleSaveCommitteeMember = async () => {
        ...
        try {
            ...
            if (editingCommitteeMemberId) {
                await axios.put(
                    `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/associations/${editingCommitteeMemberId}`,
                    { clientId: selectedClient, roleId: selectedRole },
                    { headers }
                );
            } else {
                await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/associations`, { clientId: selectedClient, roleId: selectedRole }, { headers });
            }

            const updatedResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all&template=true`, { headers });
    ...
    const handleDeleteCommitteeMember = async (memberId) => {
        ...
        try {
            ...
            await axios.delete(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/associations/${memberId}`, { headers });
    ...
    const handleActivateGroupSubmit = async () => {
        ...
        try {
            startLoading();
            await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=activate`, payload, { headers });
    ...
    const fetchStaffForOffice = async (selectedOfficeId) => {
        ...
        try {
            ...
            const staffResponse = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/template?officeId=${selectedOfficeId}&staffInSelectedOfficeOnly=true`,
                { headers }
            );
    ...
    const handleEditGroupSubmit = async () => {
        ...
        try {
            startLoading();
            await axios.put(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}`, payload, { headers });
            setIsEditModalOpen(false);

            const updatedResponse = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all`, { headers });
    ...
    const fetchGroupAssociations = async () => {
        try {
            ...
            const response = await axios.get(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all`, { headers });
            setClientMembers(
    ...
    const handleSubmitTransferClients = async () => {
        ...
        try {
            startLoading();
            await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=transferClients`, payload, { headers });
        ...
        if (isAddClientsModalOpen) {
            const fetchAllClients = async () => {
                try {
                    ...
                    const response = await axios.get(
                        `${API_CONFIG.proxy}/fineract-provider/api/v1/clients?orphansOnly=true&sortOrder=ASC&orderBy=displayName`,
                        { headers }
                    );
    ...
    const handleAddClientsToGroup = async () => {
        try {
            ...
            await axios.post(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=associateClients`,
                payload,
                { headers }
            );
    ...
    const handleRemoveClientFromGroup = async (clientId) => {
        ...
        try {
            ...
            await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=disassociateClients`, payload, { headers });
            fetchGroupClients();
        } catch (error) {
    ...
    const handleUnassignStaff = async () => {
        ...
        try {
            ...
            await axios.post(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=unassignStaff`,
                payload,
                { headers }
            );

            const response = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all`,
                { headers }
            );
    ...
    const fetchAvailableStaff = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?associations=all&template=true`,
                { headers }
            );
    ...
    const handleAssignStaff = async () => {
        ...
        try {
            ...
            await axios.post(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=assignStaff`,
                payload,
                { headers }
            );
    ...
    const fetchCalendarTypes = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/calendars/template`,
                { headers }
            );
    ...
    const handleCreateMeeting = async () => {
        ...
        try {
            ...
            await axios.post(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}/calendars`,
                payload,
                { headers }
            );
    ...
    const fetchClosureReasons = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/template?command=close`,
                { headers }
            );
    ...
    const handleCloseGroup = async () => {
        ...
        try {
            ...
            await axios.post(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/groups/${groupId}?command=close`,
                payload,
                { headers }
            );
