...
const CentersSavingsApplication = () => {
        ...
        const fetchSavingsTemplate = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    `${API_CONFIG.proxy}/fineract-provider/api/v1/savingsaccounts/template?groupId=${centerId}`,
                    { headers }
                );
    ...
    const fetchProductDetails = async (productId) => {
        ...
        try {
            ...
            const response = await axios.get(
                `${API_CONFIG.proxy}/fineract-provider/api/v1/savingsaccounts/template?groupId=${centerId}&productId=${productId}`,
                { headers }
            );
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axios.post(`${API_CONFIG.proxy}/fineract-provider/api/v1/savingsaccounts`, submissionData, { headers });
